...
from dripmailer import content as dripmailer_content # Imported the new Drip Mailer HTML content
...
# Hide Streamlit's default UI elements and prepare basic layout
st.markdown(
    """
    <style>
    ...
    /* Set dark background globally so it blends with login */
    .stApp {
...
if not st.session_state['authenticated']:
    ...
    # Render the unified HTML toolkit natively inside Streamlit
