...
def _build_clearance_block(user_email: str, user_name: str, is_leadership: bool) -> dict:
    ...
    if is_leadership:
        text = (
            ...
            "**The acknowledgement MUST match the language of the user's question** "
            "— English question gets English opening, Chinese question gets a "
            "natural Chinese opening (not a word-for-word translation, not "
            "Chinglish, not a mix of English and Chinese).\n"
            "   - **English opening template:**\n"
            "     > *\"Heads up — this is confidential Streamax pricing. Sharing "
            "because you're in the Leadership group.\"*\n"
            "   - **Chinese opening template (use 您, use 锐明 not Streamax, "
            "natural formal-but-warm register):**\n"
            "     > *\"您现在的问题涉及锐明内部的敏感信息，但是您作为锐明的"
            "高级管理层，在这里拥有最高权限，所以我可以回答您的问题。\"*\n"
