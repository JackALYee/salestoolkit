content = r"""
        ...
        <div id="dripmailer" class="content-section hidden">
            <div class="card fade-up">
                ...
                <p>Build your signature, draft dynamic templates, and batch send emails directly from your Streamax account.</p>
            </div>
